...
Date: June 12, 2026
Authors: Sam McVeety (Tech Lead, Data Analytics, Engineering, Data Cloud, Google Cloud), Amir Hormati (Tech Lead, BigQuery, Engineering, Data Cloud, Google Cloud)
...
Google Cloud's Knowledge Catalog has been updated to ingest Open Knowledge Format and serve it to agents: https://github.com/GoogleCloudPlatform/knowledge-catalog/tree/main/toolbox/mdcode/demo
